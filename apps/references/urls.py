...
urlpatterns = [
     ...
     path('econom_ref/',
          ...
          name='econom_ref'),
     path('econom_standarts/',
          views.EconomStandartsView.as_view(),
          name='econom_standarts'),
     path('econom_verif_standarts/',
          views.EconomVerifStandartsView.as_view(),
          name='econom_verif_standarts'),
]
