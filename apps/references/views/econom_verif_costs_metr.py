...
class EconomVerifCostsMetrView(LoginRequiredMixin, TemplateView):
    """
        Затраты отдела метрологии на госповерку за месяц
    """
    template_name = 'references/econom_verif_costs_metr.html'
            ...
            'moc_type').annotate(
                ...
                last_device_location=Subquery(
                    latest_device_location_query.values(
                        'department__name')[:1]),
                device_location_workshop=Subquery(
                    latest_device_location_query.values(
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render(request,
                      'references/modals/econom_verif_costs_metr_modal.html',
                      {'form': form})
